...
public class Staff extends Users {
    ...
    public boolean CheckOutItem(int book_id, Users current_borrower, ArrayList<Books> BooksList, Loan Current_Loan,
    ...
    public boolean CheckInItem(String ret_date, int book_id, Users current_borrower, ArrayList<Books> BooksList,
            List<Loan> LoanList) {
        ...
        for (int counter = LoanList.size() - 1; counter >= 0; counter--) {
            ...
            if ((L.GetaBookId() == book_id) && (L.GetaBorrowerId() == current_borrower.GetId())
                    && L.GetStatus() == false) {
    ...
    public boolean AddaBorrower(ArrayList<Users> BorrowerList, String borrower_name, char borrower_gender,
            String telephone_number, String address) {
        Users LastBorrower = BorrowerList.get(BorrowerList.size() - 1);
        int LastBorrowerId = LastBorrower.GetId();
        int new_id = LastBorrowerId + 1;
        Borrower NewBorrower = new Borrower(new_id, borrower_name, borrower_gender, telephone_number, address, false,
                0.0);
    ...
    public boolean UpdatePerosnalInformation(ArrayList<Users> BorrowerList, String Info, int command, int user_id) {
        // System.out.println("Enter the id of user whose information you want to
        // update");
